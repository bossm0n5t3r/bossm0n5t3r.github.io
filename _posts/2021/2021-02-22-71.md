...
image:
  src: /assets/img/posts/71/jeswin-thomas-hecib2an4T4-unsplash.jpg
pin: false
math: true
published: true
---
...
> its nodes as $$v_1, v_2, …, v_n$$ so that for every edge $$(vi, vj)$$ we have $$i < j$$.
...
![More_details_be_omitted.jpg](/assets/img/posts/71/More_details_be_omitted.jpg){: width="400"}
...
![git-model.png](/assets/img/posts/71/git-model.png){: width="400"}
